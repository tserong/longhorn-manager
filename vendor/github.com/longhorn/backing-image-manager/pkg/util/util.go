...
func GetImageVirtualSize(filePath string) (int64, error) {
	...
	// If it's a raw file, qemu-img info will return virtual size same as size
	// Note that we will actually need a test in SyncTestSuite with a real qcow2
	// file to verify that we get a big virtual size and a little file size!
